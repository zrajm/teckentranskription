...
function transcriptKeyboard(jqText) {
    var domText = jqText.get(0), jqKeyboard = $('#keyboard'), jqInput = $('#input')

    // For inserting text in a textarea.
    function insertAtCursor(str) {
        var sel, begPos, endPos, newPos, value,
            domFocused = document.activeElement, refocused = false
    ...
    function button_clicked(e) {
        ...
        case 32:                     // Space
            ...
            if ($(e.target).is('button')) {
                ...
                var str = $(e.target).html().replace(/(&nbsp;|◌)/g, '')
                insertAtCursor(str)
            }
        }
        return true
    ...
    $(function () {
        ...
        jqText.
            ...
            click(function()  { jqKeyboard.show() })
